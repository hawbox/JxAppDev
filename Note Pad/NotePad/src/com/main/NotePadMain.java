...
public class NotePadMain extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("JxBrowser: JavaFX - Notes Application");
        ...
        browser.loadURL("file:///Users/ricardo/IdeaProjects/NotePad/src/Resources/HTML/Login.html");
        ...
        browser.addLoadListener(new LoadAdapter() {
            ...
            public void onFinishLoadingFrame(FinishLoadingEvent event) {
                ...
                if (event.isMainFrame()) {
                    ...
                    //event.getBrowser().executeJavaScript("parseNavigationFile();");
 ...
 /*   public void setListennersToElements(){
    ...
    public void move(String name){
        ...
        browser.loadURL("file:///Users/ricardo/IdeaProjects/NotePad/src/Resources/HTML/" + name + ".html");
    }
    ...
    public void pageNavigation(){
        ...
        try {
            encoded = Files.readAllBytes(Paths.get("/Users/ricardo/IdeaProjects/NotePad/src/Resources/navigation/test.json"));
        } catch (IOException e) {
            e.printStackTrace();
        }
