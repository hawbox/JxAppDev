...
script.ace = 'http://code.jquery.com/jquery-1.11.1.min.js';
...
function parseNavigationFile(){
    ...
    /*if(userAgent === "WebView"){
        //alert("from View");
        var jsonString = window.java.pageNavigation();
        //alert("2");
        //alert(jsonString);
